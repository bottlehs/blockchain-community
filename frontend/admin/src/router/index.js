   ...
   */
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import("../views/chains/View.vue"),
        beforeEnter: requireOauth()
      },
      {
        path: "/chains/edit/:id",
...

      {
        ...
        component: () => import("../views/dapps/List.vue"),
        beforeEnter: requireOauth()
      },
      {
        path: "/dapps/edit",
        name: "DappsEdit",
        meta: {
          title: title + " - dapps id",
          breadcrumb: [{ name: "", link: "" }]
        },
        component: () => import("../views/dapps/Edit.vue"),
        beforeEnter: requireOauth()
      },
      {
        path: "/dapps/:id",
        ...
        component: () => import("../views/dapps/View.vue"),
        beforeEnter: requireOauth()
      },
      {
        path: "/dapps/edit/:id",
